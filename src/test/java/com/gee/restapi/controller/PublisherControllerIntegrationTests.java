...
public class PublisherControllerIntegrationTests {
    ...
    public void setup() {
        ...
        publisher1.setName("Test Publisher1");
//        Publisher publisher2 = new Publisher();
//        publisher2.setName("Test Publisher2");
//        Publisher publisher3 = new Publisher();
//        publisher3.setName("Test Publisher3");
...
//        publisherRepository.save(publisher3);
    ...
    @Test
    public void testFindAllPublishersReturnHttpStatus200AndPublishers() throws Exception {
        mockMvc.perform(
